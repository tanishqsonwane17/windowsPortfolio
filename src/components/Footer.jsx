...
const Footer = () => {
  ...
  return (
    ...
    <div className='h-14 w-full flex justify-end fixed bottom-0  backdrop-blur-3xl'>
      ...
      <div className='h-full text-white w-[70%] items-center flex justify-end px-4'>
       <div className='h-11 rounded-sm flex justify-center items-center cursor-pointer px-1 mr-6 hover:bg-[#7272721d] gap-2 text-lg'>
        ...
        <div className='flex flex-col h-8 hover:bg-[#7272721d] cursor-pointer text-[12px] justify-center items-center'>
