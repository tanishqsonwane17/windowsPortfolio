...
const RightMenu = ({ onNewFolder }) => {
  return (
    <div className='w-50 backdrop-blur-2xl bg-[#d5cece63] text-[#000000] rounded-2xl'>
      <ul className='flex flex-col gap-4 px-2 py-4'>
        <div className='flex flex-col gap-2'>
          <li className='flex gap-2 items-center cursor-pointer px-4 rounded-2xl'> 
            <CiBoxList /> View
          </li>
          <li className='flex gap-2 items-center cursor-pointer  px-4 rounded-2xl'> 
         ...
         <li
            ...
            className='flex gap-2 items-center cursor-pointer  px-4 rounded-2xl'> 
            <IoRefresh /> Refresh
          </li>
        </div>
